...
export const metadata: Metadata = {
  title:
    "Équipe Camino TV - Créateurs & Influenceurs Streetwear France | Camino TV",
  description:
    "Découvrez l'équipe passionnée de Camino TV : Sean, Mike, Keusmo, Elssy, Monroe, Piway et Messaoud. Créateurs de contenu, influenceurs et experts streetwear français qui font rayonner la culture urbaine.",
  keywords: [
    "équipe camino tv",
  ...
  openGraph: {
    ...
    description:
      "Rencontrez les visages passionnés derrière Camino TV. De Sean le fondateur à Keusmo l'influenceur, découvrez notre équipe de créateurs streetwear français.",
    siteName: "Camino TV",
    images: [
      {
        url: "/og-team.jpg",
  ...
  twitter: {
    ...
    description:
      "Découvrez les créateurs passionnés derrière la plus grande communauté streetwear française.",
  },
};
...
export default function TeamPage() {
  const teamStructuredData = {
    ...
    description:
      "Plateforme streetwear française et communauté de créateurs de contenu mode urbaine",
    foundingDate: "2020",
    founders: [
      {
        "@type": "Person",
      ...
      <div className="min-h-screen bg-background">
        ...
        <div className="max-w-6xl mx-auto px-4 py-16">
          ...
          <section className="mb-16">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
              {getTeamMembersByIds(["monroe", "mike", "souk"]).map(
                (member, index) => (
                  <TeamMemberCard
                    key={member.id}
                    member={member}
          ...
          <section className="mb-16">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
              {getTeamMembersByIds(["bous", "piway", "wade"]).map(
                (member, index) => (
                  <TeamMemberCard
                    key={member.id}
                    member={member}
          ...
          <section className="mb-16">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
              {getTeamMembersByIds(["adlane", "alexis", "messaoud"]).map(
                (member, index) => (
                  <TeamMemberCard
                    key={member.id}
                    member={member}
          ...
          <section className="mb-16">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
              {getTeamMembersByIds(["sean", "chasseur", "linda", "greed"]).map(
                (member, index) => (
                  <TeamMemberCard
                    key={member.id}
                    member={member}
          ...
          <div className="text-center mb-16">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
              <div className="group p-8 bg-card rounded-xl border hover:border-brand-300 dark:hover:border-brand-700 hover:shadow-lg hover:shadow-brand-500/10 hover:scale-[1.02] transition-all duration-300 cursor-pointer">
                <div className="text-5xl mb-6 group-hover:scale-105 transition-all duration-300">
                  🎯
                </div>
                <h3 className="text-xl font-bold mb-4 group-hover:text-brand-600 transition-colors duration-300">
                  Authenticité
                </h3>
                <p className="text-muted-foreground group-hover:text-foreground transition-colors duration-300 leading-relaxed">
                  Nous restons fidèles à nos valeurs et partageons notre passion
                  de manière authentique avec notre communauté.
                </p>
              </div>
              ...
              <div className="group p-8 bg-card rounded-xl border hover:border-brand-300 dark:hover:border-brand-700 hover:shadow-lg hover:shadow-brand-500/10 hover:scale-[1.02] transition-all duration-300 cursor-pointer">
                ...
                <p className="text-muted-foreground group-hover:text-foreground transition-colors duration-300 leading-relaxed">
                  Notre force réside dans notre communauté. Nous créons des
                  liens durables et partageons nos découvertes.
                </p>
              </div>
              ...
              <div className="group p-8 bg-card rounded-xl border hover:border-brand-300 dark:hover:border-brand-700 hover:shadow-lg hover:shadow-brand-500/10 hover:scale-[1.02] transition-all duration-300 cursor-pointer">
                ...
                <p className="text-muted-foreground group-hover:text-foreground transition-colors duration-300 leading-relaxed">
                  Nous repoussons constamment les limites pour offrir le
                  meilleur contenu et les meilleures expériences.
                </p>
              </div>
            </div>
          </div>
          ...
          <div className="grid grid-cols-2 md:grid-cols-5 gap-6 mb-16">
            <a
              href="https://youtube.com/@CaminoTV"
              target="_blank"
              rel="noopener noreferrer"
              className="text-center p-8 bg-card rounded-xl border border-red-200/50 dark:border-red-800/30 hover:border-red-400 dark:hover:border-red-600 hover:scale-[1.02] hover:shadow-lg hover:shadow-red-500/10 transition-all duration-300 group cursor-pointer block"
            >
            ...
            <a
              href="https://instagram.com/caminotv"
              target="_blank"
              rel="noopener noreferrer"
              className="text-center p-8 bg-card rounded-xl border border-pink-200/50 dark:border-pink-800/30 hover:border-pink-400 dark:hover:border-pink-600 hover:scale-[1.02] hover:shadow-lg hover:shadow-pink-500/10 transition-all duration-300 group cursor-pointer block"
            >
            ...
            <a
              ...
              target="_blank"
              rel="noopener noreferrer"
              className="text-center p-8 bg-card rounded-xl border border-purple-200/50 dark:border-purple-800/30 hover:border-purple-400 dark:hover:border-purple-600 hover:scale-[1.02] hover:shadow-lg hover:shadow-purple-500/10 transition-all duration-300 group cursor-pointer block"
            >
            ...
            <a
              ...
              target="_blank"
              rel="noopener noreferrer"
              className="text-center p-8 bg-card rounded-xl border border-gray-200/50 dark:border-gray-800/30 hover:border-gray-400 dark:hover:border-gray-600 hover:scale-[1.02] hover:shadow-lg hover:shadow-gray-500/10 transition-all duration-300 group cursor-pointer block"
            >
            ...
            <a
              ...
              target="_blank"
              rel="noopener noreferrer"
              className="text-center p-8 bg-card rounded-xl border border-slate-200/50 dark:border-slate-800/30 hover:border-slate-400 dark:hover:border-slate-600 hover:scale-[1.02] hover:shadow-lg hover:shadow-slate-500/10 transition-all duration-300 group cursor-pointer block"
            >
              <div className="text-4xl font-bold text-gray-800 dark:text-gray-200 mb-4 group-hover:scale-105 group-hover:text-gray-600 transition-all duration-300">
                <AnimatedNumber
                  value={708000}
              ...
              <div className="flex justify-center">
                <svg
                  className="h-8 w-8 text-gray-800 dark:text-gray-200 group-hover:scale-105 group-hover:text-gray-600 transition-all duration-300"
                  fill="currentColor"
                  viewBox="0 0 24 24"
                  aria-hidden="true"
                >
          ...
          <Card className="text-center p-12">
            ...
            <p className="text-lg text-muted-foreground mb-8 max-w-2xl mx-auto">
              Suivez-nous sur nos réseaux sociaux pour ne rien rater de nos
              dernières découvertes et bons plans.
            </p>
            <div className="flex flex-wrap justify-center gap-4">
              ...
              <Button
                asChild
                variant="outline"
                className="border-pink-300 text-pink-600 hover:bg-pink-50 dark:border-pink-800 dark:text-pink-400 dark:hover:bg-pink-950/50"
              >
                <a
                  href="https://instagram.com/caminotv"
                  target="_blank"
              ...
              <Button
                asChild
                variant="outline"
                className="border-purple-300 text-purple-600 hover:bg-purple-50 dark:border-purple-800 dark:text-purple-400 dark:hover:bg-purple-950/50"
              >
                <a
                  href="https://www.twitch.tv/caminotv"
                  target="_blank"
              ...
              <Button
                asChild
                variant="outline"
                className="border-gray-300 text-gray-600 hover:bg-gray-50 dark:border-gray-700 dark:text-gray-400 dark:hover:bg-gray-950/50"
              >
                <a
                  href="https://x.com/CaminoTV"
                  target="_blank"
              ...
              <Button
                asChild
                variant="outline"
                className="border-slate-300 text-slate-600 hover:bg-slate-50 dark:border-slate-700 dark:text-slate-400 dark:hover:bg-slate-950/50"
              >
                <a
                  href="https://www.tiktok.com/@caminotv?lang=fr"
                  target="_blank"
...
function getTeamMembersByIds(ids: string[]) {
  return ids
    ...
    .filter(Boolean) as typeof mockAuthors;
}
          ...
          <div className="absolute bottom-2 left-2 right-2 transform translate-y-2 opacity-0 group-hover:translate-y-0 group-hover:opacity-100 transition-all duration-300">
            <div className="flex gap-1 justify-center">
              <Button
                ...
                size="sm"
                variant="secondary"
                className="bg-white/20 backdrop-blur-sm hover:bg-white/30 text-white border-white/20 hover:scale-105 transition-all duration-200 h-8 w-8 p-0"
              >
                <a
                  href={getSocialLink(member.id, "instagram")}
                  target="_blank"
                  rel="noopener noreferrer"
                >
              ...
              {getSocialLink(member.id, "twitter") !== "#" && (
                ...
                >
                  <a
                    href={getSocialLink(member.id, "twitter")}
                    target="_blank"
                    rel="noopener noreferrer"
                  >
