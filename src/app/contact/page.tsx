...
export const metadata: Metadata = {
  ...
  description: "Contactez l'équipe Camino TV pour vos questions, partenariats, collaborations ou suggestions. Nous répondons à tous vos messages dans les plus brefs délais.",
  keywords: [
    "contact camino tv",
  ...
  twitter: {
    ...
    site: "@CaminoTV",
    title: "Contact - Nous contacter | Camino TV",
    description: "Contactez l'équipe Camino TV pour vos questions, partenariats et collaborations.",
  },
};
