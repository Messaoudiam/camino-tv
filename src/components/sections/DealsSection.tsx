...
export function DealsSection({ className }: DealsSectionProps) {
  ...
  const filteredDeals = deals
    .filter((deal) => {
      ...
      if (minDiscount[0] > 0 && deal.discountPercentage < minDiscount[0])
        return false;
  ...
  return (
    <TooltipProvider>
      <section id="deals-section" className={cn("py-8", className)}>
        <div className="max-w-7xl mx-auto px-4">
          {/* Header avec responsive optimisé */}
          <div className="text-center mb-6 md:mb-8">
            <div className="flex items-center justify-center gap-2 md:gap-3 mb-3 md:mb-4"></div>
