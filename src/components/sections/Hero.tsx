      ...
      <div className="container mx-auto px-4 py-16 md:py-24 relative z-10">
        <div className="max-w-5xl mx-auto text-center">
          ...
          <h1 className="text-5xl md:text-7xl lg:text-8xl font-bold mb-6 leading-tight text-foreground">
            <span className="inline-block hover:scale-105 transition-transform duration-300">Camino</span>
          ...
          <p className="text-lg md:text-xl text-muted-foreground mb-12 max-w-2xl mx-auto leading-relaxed">
            ...
            <br />
            <span className="font-semibold text-foreground">Passion, communauté et création sans limites.</span>
          </p>
          ...
          <div className="flex flex-wrap justify-center gap-8 md:gap-12 mb-12">
            ...
            <div className="text-center group hover:scale-105 transition-transform duration-300">
              <div className="text-3xl md:text-4xl font-bold text-red-600 mb-1">300K+</div>
              <div className="text-sm text-muted-foreground font-medium">YouTube</div>
            </div>
            <div className="text-center group hover:scale-105 transition-transform duration-300">
              <div className="text-3xl md:text-4xl font-bold text-red-400 mb-1">560K+</div>
