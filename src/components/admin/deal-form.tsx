...
export function DealForm({
  ...
  const handleFormSubmit = (data: DealFormValues) => {
    ...
    const cleanedData = {
      ...data,
      originalPrice: isNaN(data.originalPrice as number) ? 0 : data.originalPrice,
      discountPercentage: isNaN(data.discountPercentage as number) ? 0 : data.discountPercentage,
    }
    ...
    <Dialog open={open} onOpenChange={onOpenChange}>
      <DialogContent className="max-w-2xl max-h-[90vh] overflow-y-auto">
        ...
        <form onSubmit={handleSubmit(handleFormSubmit)} className="space-y-6">
            ...
            <div className="space-y-2">
              ...
              <Input
                ...
                {...register('originalPrice', {
                  setValueAs: (v) => v === '' || v === null ? 0 : parseFloat(v)
                })}
          ...
          {/* Description promo */}
          <div className="space-y-2">
            <Label htmlFor="promoDescription">Description du promo (optionnel)</Label>
            <Textarea
              id="promoDescription"
          ...
          <DialogFooter>
            ...
            <Button type="submit" disabled={isSubmitting}>
              ...
              {mode === 'create' ? 'Créer le deal' : 'Enregistrer les modifications'}
            </Button>
          </DialogFooter>
        </form>
      </DialogContent>
